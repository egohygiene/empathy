...
ACTION_ROOT = REPOSITORY_ROOT / ".github/actions/normalize-repository-report"
FIXTURE_ROOT = REPOSITORY_ROOT / "tests/fixtures/repository-reports"
MODULE_PATH = ACTION_ROOT / "normalize_repository_report.py"
...
class RepositoryReportNormalizationTests(unittest.TestCase):
    ...
    def test_checked_in_schema_declares_the_common_contract(self) -> None:
        schema = json.loads(
            (ACTION_ROOT / "repository-report-summary.schema.json").read_text(encoding="utf-8")
        )
