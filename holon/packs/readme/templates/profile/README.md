...
<p align="center">
  <picture>
    ...
    <img src="./assets/profile/banner-light.svg" alt="{{PROFILE_NAME}} — {{PROFILE_VISUAL_DESCRIPTION}}" width="100%">
  </picture>
</p>
...
```mermaid
flowchart TD
    A["{{ECOSYSTEM_LAYER_ONE}}"] --> D["{{SHARED_OUTCOME}}"]
    B["{{ECOSYSTEM_LAYER_TWO}}"] --> D
    C["{{ECOSYSTEM_LAYER_THREE}}"] --> D
    D --> E["{{PRODUCT_OR_USER_OUTCOME}}"]
```
...
<details>
  <summary>View selected public activity</summary>
  ...
  <picture>
    ...
    <img src="./assets/generated/activity-light.svg" alt="{{ACTIVITY_ASSET_ALT_TEXT}}" width="100%">
  </picture>
</details>
...
<p align="right"><a href="#profile-top">Back to top</a></p>
